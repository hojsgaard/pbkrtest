...
<<echo=F>>= 
dub=structure(list(y1 = c(0.704095556003977, 1.00904040901664, -0.349571365574127, 
0.391372370428952, -0.691285945682357, -0.0626569547151486, -2.45107333046413, 
-1.79713108369372, 1.49399597808214, 1.53085564291694, 0.940058524643779, 
1.02325089228205), y2 = c(0L, 0L, 0L, 2L, 1L, 0L, 0L, 2L, 4L, 
5L, 2L, 0L), trt = structure(c(1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 
2L, 2L, 2L, 2L), .Label = c("ctrl", "trt1"), class = "factor"), 
    subj = structure(c(1L, 1L, 2L, 2L, 3L, 3L, 4L, 4L, 5L, 5L, 
    6L, 6L), .Label = c("subj1", "subj2", "subj3", "subj4", "subj5", 
    "subj6"), class = "factor")), .Names = c("y1", "y2", "trt", 

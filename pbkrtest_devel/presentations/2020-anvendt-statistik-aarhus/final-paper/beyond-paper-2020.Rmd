...
**Resumé:** _Inferens i lineære mixed models og i generaliserede lineære mixed
...
names(b)[1]<-"statistic"
kable(a, booktabs=T,
      caption="Resultat efter at fitte en mixed model med unit som tilfældig effekt. Den rapporterede $p$-værdi er for testet af ingen effekt at behandling og er beregnet ved parametrisk bootstrap.")  %>% 
    kable_styling(latex_options =c("hold_position"))
```

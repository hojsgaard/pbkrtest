...
<<>>=
c(bal_ddf = getKR(kr.b, "ddf"), imbal_ddf = getKR(kr.i, "ddf"))
@ %def
...
<<>>=
sat.b <- SATmodcomp(lmm1.b, lmm0.b)
sat.b
@ 

<<>>=
sat.i <- SATmodcomp(lmm1.i, lmm0.i)
sat.i
@ 
...
<<>>=
c(bal_ddf = getSAT(sat.b, "ddf"), imbal_ddf = getSAT(sat.i, "ddf"))
@ %def

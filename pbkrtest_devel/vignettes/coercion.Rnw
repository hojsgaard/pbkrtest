...
library(knitr)
opts_chunk$set(
fig.path='figures/pbkr', tidy=FALSE, fig.height=4
)
@
...
<<>>=
L21 <- model2restriction_matrix(mod2, mod1); L21
L20 <- model2restriction_matrix(mod2, mod0); L20
L10 <- model2restriction_matrix(mod1, mod0); L10
@ 
...
<<>>=
new1  <- restriction_matrix2model(mod2, L21); coef(new1)
new0a <- restriction_matrix2model(mod2, L20); coef(new0a)
new0b <- restriction_matrix2model(mod1, L10); coef(new0b)
@ 

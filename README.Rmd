...
# `pbkrtest`: Parametric Bootstrap, Kenward-Roger and Satterthwaite Based Methods for Tests in Mixed Models
...
cite the 2012-paper. 
Please notice: There are other packages that use `pbkrtest`

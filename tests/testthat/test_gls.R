...
test_that("test corCompSymm vs random intercept", {
  ...
  kr.lmer <- KRmodcomp(fm1.lmer, fm0.lmer)
  kr.lme <- KRmodcomp(fm1.lme, fm0.lme)
  kr.gls <- KRmodcomp(fm1.gls, fm0.gls)
...
test_that("test robustness to missing and permuted data", {
  ...
  kr1.gls <- KRmodcomp(fm11.gls, fm01.gls)
  kr2.gls <- KRmodcomp(fm12.gls, fm02.gls)
